...
void swap_init(void) {
	...
	if (swap_block) {
		size_t total_pages = block_size(swap_block) / SECTORS_PER_PAGE;
		swap_map = bitmap_create(total_pages);
		if (swap_map) {
